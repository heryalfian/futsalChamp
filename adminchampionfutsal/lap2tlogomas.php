...
WHERE pelanggan.id_pelanggan=pemesanan.id_pelanggan AND pemesanan.lpgn=2 AND pemesanan.id_lokasi=2");
...
<div class="container">
	...
	<table class="taokdata" border="1" cellpadding="10" cellspacing="0">
		...
		<select class="plhcabang" align="center" onchange="location = this.value">
				...
				<option value="lap1tlogomas.php" selected="
				"> Champion Futsal Tlogomas</option>
