...
WHERE pelanggan.id_pelanggan=pemesanan.id_pelanggan AND pemesanan.lpgn=2 AND pemesanan.id_lokasi=1");
...
<div class="container">
	...
	<table class="taokdata" border="1" cellpadding="10" cellspacing="0">
		...
		<select class="plhcabang" align="center" onchange="location = this.value">
				<option value="goal.php" selected=""> Champion Futsal Suhat</option>
				<option value="lap1tlogomas.php"> Champion Futsal Tlogomas</option>
				<option value="lap1matos.php"> Champion Futsal Matos</option>			
		</select> <br>

		<button class="pilen" onclick="pindahlaman('goal.php')"> Lapangan 1</button>
		<button class="pilen" onclick="pindahlaman('lap2suhat.php')"> Lapangan 2</button>
