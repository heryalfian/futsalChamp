...
WHERE pelanggan.id_pelanggan=pemesanan.id_pelanggan AND pemesanan.lpgn=1 AND pemesanan.id_lokasi=1");
...
<div class="container">
	...
	<div class="admin">
		...
		<button class="pilihmenu" selected="">DATA PEMESANAN </button>
		<button class="pilihmenu" onclick="pindahlaman('karyawan.html')"> DATA KARYAWAN </button>

		<button class="pilihmenu" onclick="pindahlaman('about.html')"> ABOUT</button>
	</div>
