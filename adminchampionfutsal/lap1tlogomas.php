...
$result = mysqli_query($conn,"SELECT pelanggan.id_pelanggan, pelanggan.nama, pelanggan.no_hp, pemesanan.id_pemesanan, pemesanan.id_lokasi, 
pemesanan.tgl_pesan, pemesanan.jam_pesan, pemesanan.lpgn, pemesanan.jam_main, pemesanan.durasi FROM pelanggan, pemesanan
WHERE pelanggan.id_pelanggan=pemesanan.id_pelanggan AND pemesanan.lpgn=1 AND pemesanan.id_lokasi=2");
...
<div class="container">
	...
	<table class="taokdata" border="1" cellpadding="10" cellspacing="0">
		...
		<select class="plhcabang" align="center" onchange="location = this.value">
				...
				<option value="lap1tlogomas.php" selected=""> Champion Futsal Tlogomas</option>
				<option value="lap1matos.php"> Champion Futsal Matos</option>			
		</select> <br>

		<button class="pilen" onclick="pindahlaman('lap1tlogomas.php')"> Lapangan 1</button>
		<button class="pilen" onclick="pindahlaman('lap2tlogomas.php')"> Lapangan 2</button>
		<button class="pilen" onclick="pindahlaman('lap3tlogomas.php')"> Lapangan 3</button>
		<button class="pilen" onclick="pindahlaman('lap4tlogomas.php')"> Lapangan 4</button>
